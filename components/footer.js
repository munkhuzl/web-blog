  ...
  return (
    <footer class=" dark:bg-gray-700  bg-gray-100 justify-around ">
      <div class="mx-auto w-full max-w-screen-xl ">
        <div class="grid grid-cols gap-8 px-4 py-6 lg:py-8 md:grid-cols-3 ">
        ...
        <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between  justify-center">
          MetaBlog
